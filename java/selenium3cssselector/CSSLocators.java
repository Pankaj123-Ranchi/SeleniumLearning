...
public class CSSLocators {
	...
	public static void main(String[] args) {
		...
		//tag class attribute
		//driver.findElement(By.cssSelector("input.search-box-text[name='q']")).sendKeys("T Shirt Polo");
		//driver.findElement(By.cssSelector(".search-box-text[name='q']")).sendKeys("T Shirt Polo");
	}
